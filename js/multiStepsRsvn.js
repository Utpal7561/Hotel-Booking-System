...
let multiStepRsvnFormId = '#multiStepRsvnForm';
let multiStepRsvnformData = {
  cDate: function (dt) {
...
class ReservationCost {
  ...
  displayRoomPrice () {
    document.getElementsByClassName('roomPriceTt')[0].innerHTML = "₹" + this.numNights() * this.priceByRoomType();
  }
