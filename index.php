...
<main role="main">
    <section class="jumbotron text-center custom-bg" style="background: 
   linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 70%, rgba(0, 0, 0, 0.65) 100%),
   url('./image/new/aa.jpg') no-repeat; background-size: cover; background-position: center;">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-4" style="color:white"> <b>A brand new hotel beyond ordinary</b></h1>
            <h6 class="display-5" style="color:white">Book your summer holidays with us now.</h6>
            <p>
                <?php if ($isSessionExists) { ?>
                        ...
                        <form role="form" autocomplete="off" method="post" id="multiStepRsvnForm">
                            ...
                            <div class="rsvnTab">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9 roomPriceTt"></div>
                                </div>
                                <div class="form-group row align-items-center">
